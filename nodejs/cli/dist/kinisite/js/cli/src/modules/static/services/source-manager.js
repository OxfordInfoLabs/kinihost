...
var SourceManager = /** @class */ (function () {
     ...
     * @param api
     */
    function SourceManager(api, siteConfig) {
        this._excludedPaths = ["node_modules", ".git", ".svn", ".k-cache"];
     ...
     */
    SourceManager.prototype.getRemoteObjectFootprints = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._api.callMethod("/cli/staticwebsite/source/footprints/" + this._siteConfig.siteKey)];
     ...
     */
    SourceManager.prototype.getLocalObjectFootprints = function (subDir) {
        var _this = this;
     ...
     */
    SourceManager.prototype.generateChanges = function (existingFootprints, newFootprints) {
        var changes = [];
     ...
     */
    SourceManager.prototype.calculateChanges = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param changes
     */
    SourceManager.prototype.createRemoteUploadBuild = function (changes) {
        return __awaiter(this, void 0, void 0, function () {
            var uploadBuild;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._api.callMethod("/cli/staticwebsite/source/upload/create/" + this._siteConfig.siteKey, "POST", null, changes)];
                    case 1:
                        uploadBuild = _a.sent();
     ...
     * @param uploadUrls
     */
    SourceManager.prototype.uploadFiles = function (uploadUrls) {
        var _this = this;
     ...
     * @param bar
     */
    SourceManager.prototype.uploadFileSet = function (uploadUrls, bar, index) {
        var _this = this;
     ...
     * @param uploadUrl
     */
    SourceManager.prototype.uploadFile = function (localFilename, uploadUrl) {
        var _this = this;
        return new Promise(function (resolve) {
     ...
     */
    SourceManager.prototype.getRemoteDownloadUrls = function (changedObjects) {
        var _this = this;
        var downloadObjects = [];
        ...
        return new Promise(function (resolve) {
            _this._api.callMethod("/cli/staticwebsite/source/download/create/" + _this._siteConfig.siteKey, "POST", null, downloadObjects).then(function (downloadUrls) {
     ...
     * @param downloadUrls
     */
    SourceManager.prototype.downloadFiles = function (downloadUrls) {
        var _this = this;
        return new Promise(function (resolve) {
            var multibar = new cliProgress.MultiBar({
                clearOnComplete: false,
     ...
     * @param index
     */
    SourceManager.prototype.downloadFileSet = function (downloadUrls, bar, index) {
        var _this = this;
        if (index === void 0) { index = 0; }
        return new Promise(function (resolve) {
     ...
     * @param localFilename
     */
    SourceManager.prototype.downloadFile = function (remoteUrl, localFilename) {
        return new Promise(function (resolve) {
     ...
     * @param changedObjects
     */
    SourceManager.prototype.removeDeletedLocalFiles = function (changedObjects) {
        var _this = this;
    ...
    SourceManager.prototype.removeEmptyDirectories = function (parentDirectory) {
        var _this = this;
    ...
    SourceManager.prototype._isSymLinkDirectory = function (filename) {
